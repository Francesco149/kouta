...
kt_op_t kt_op_table[512] = {
    ...
    { 0xCF, "RST", KT_LOMEM, 0x08, 0, 0, kt_rst_lomem, 1, 16 },
    ...
    { 0xE7, "RST", KT_LOMEM, 0x20, 0, 0, kt_rst_lomem, 1, 16 },
    ...
    { 0xF7, "RST", KT_LOMEM, 0x30, 0, 0, kt_rst_lomem, 1, 16 },
    ...
    { 0xA9, "RES", KT_REG, KT_C, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xAA, "RES", KT_REG, KT_D, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xAB, "RES", KT_REG, KT_E, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xAC, "RES", KT_REG, KT_H, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xAD, "RES", KT_REG, KT_L, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xAE, "RES", KT_REG_IND, KT_HL, KT_BIT, 5, kt_res_hl_ind, 2, 16 },
    { 0xAF, "RES", KT_REG, KT_A, KT_BIT, 5, kt_res_reg8, 2, 8 },
    { 0xB0, "RES", KT_REG, KT_B, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB1, "RES", KT_REG, KT_C, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB2, "RES", KT_REG, KT_D, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB3, "RES", KT_REG, KT_E, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB4, "RES", KT_REG, KT_H, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB5, "RES", KT_REG, KT_L, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB6, "RES", KT_REG_IND, KT_HL, KT_BIT, 6, kt_res_hl_ind, 2, 16 },
    { 0xB7, "RES", KT_REG, KT_A, KT_BIT, 6, kt_res_reg8, 2, 8 },
    { 0xB8, "RES", KT_REG, KT_B, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xB9, "RES", KT_REG, KT_C, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xBA, "RES", KT_REG, KT_D, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xBB, "RES", KT_REG, KT_E, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xBC, "RES", KT_REG, KT_H, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xBD, "RES", KT_REG, KT_L, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xBE, "RES", KT_REG_IND, KT_HL, KT_BIT, 7, kt_res_hl_ind, 2, 16 },
    { 0xBF, "RES", KT_REG, KT_A, KT_BIT, 7, kt_res_reg8, 2, 8 },
    { 0xC0, "SET", KT_REG, KT_B, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC1, "SET", KT_REG, KT_C, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC2, "SET", KT_REG, KT_D, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC3, "SET", KT_REG, KT_E, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC4, "SET", KT_REG, KT_H, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC5, "SET", KT_REG, KT_L, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC6, "SET", KT_REG_IND, KT_HL, KT_BIT, 0, kt_set_hl_ind, 2, 16 },
    { 0xC7, "SET", KT_REG, KT_A, KT_BIT, 0, kt_set_reg8, 2, 8 },
    { 0xC8, "SET", KT_REG, KT_B, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xC9, "SET", KT_REG, KT_C, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xCA, "SET", KT_REG, KT_D, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xCB, "SET", KT_REG, KT_E, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xCC, "SET", KT_REG, KT_H, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xCD, "SET", KT_REG, KT_L, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xCE, "SET", KT_REG_IND, KT_HL, KT_BIT, 1, kt_set_hl_ind, 2, 16 },
    { 0xCF, "SET", KT_REG, KT_A, KT_BIT, 1, kt_set_reg8, 2, 8 },
    { 0xD0, "SET", KT_REG, KT_B, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD1, "SET", KT_REG, KT_C, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD2, "SET", KT_REG, KT_D, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD3, "SET", KT_REG, KT_E, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD4, "SET", KT_REG, KT_H, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD5, "SET", KT_REG, KT_L, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD6, "SET", KT_REG_IND, KT_HL, KT_BIT, 2, kt_set_hl_ind, 2, 16 },
    { 0xD7, "SET", KT_REG, KT_A, KT_BIT, 2, kt_set_reg8, 2, 8 },
    { 0xD8, "SET", KT_REG, KT_B, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xD9, "SET", KT_REG, KT_C, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xDA, "SET", KT_REG, KT_D, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xDB, "SET", KT_REG, KT_E, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xDC, "SET", KT_REG, KT_H, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xDD, "SET", KT_REG, KT_L, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xDE, "SET", KT_REG_IND, KT_HL, KT_BIT, 3, kt_set_hl_ind, 2, 16 },
    { 0xDF, "SET", KT_REG, KT_A, KT_BIT, 3, kt_set_reg8, 2, 8 },
    { 0xE0, "SET", KT_REG, KT_B, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE1, "SET", KT_REG, KT_C, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE2, "SET", KT_REG, KT_D, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE3, "SET", KT_REG, KT_E, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE4, "SET", KT_REG, KT_H, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE5, "SET", KT_REG, KT_L, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE6, "SET", KT_REG_IND, KT_HL, KT_BIT, 4, kt_set_hl_ind, 2, 16 },
    { 0xE7, "SET", KT_REG, KT_A, KT_BIT, 4, kt_set_reg8, 2, 8 },
    { 0xE8, "SET", KT_REG, KT_B, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xE9, "SET", KT_REG, KT_C, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xEA, "SET", KT_REG, KT_D, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xEB, "SET", KT_REG, KT_E, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xEC, "SET", KT_REG, KT_H, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xED, "SET", KT_REG, KT_L, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xEE, "SET", KT_REG_IND, KT_HL, KT_BIT, 5, kt_set_hl_ind, 2, 16 },
    { 0xEF, "SET", KT_REG, KT_A, KT_BIT, 5, kt_set_reg8, 2, 8 },
    { 0xF0, "SET", KT_REG, KT_B, KT_BIT, 6, kt_set_reg8, 2, 8 },
    { 0xF1, "SET", KT_REG, KT_C, KT_BIT, 6, kt_set_reg8, 2, 8 },
    ...
    { 0xF7, "SET", KT_REG, KT_A, KT_BIT, 6, kt_set_reg8, 2, 8 },
    { 0xF8, "SET", KT_REG, KT_B, KT_BIT, 7, kt_set_reg8, 2, 8 },
    { 0xF9, "SET", KT_REG, KT_C, KT_BIT, 7, kt_set_reg8, 2, 8 },
    { 0xFA, "SET", KT_REG, KT_D, KT_BIT, 7, kt_set_reg8, 2, 8 },
    { 0xFB, "SET", KT_REG, KT_E, KT_BIT, 7, kt_set_reg8, 2, 8 },
    { 0xFC, "SET", KT_REG, KT_H, KT_BIT, 7, kt_set_reg8, 2, 8 },
    { 0xFD, "SET", KT_REG, KT_L, KT_BIT, 7, kt_set_reg8, 2, 8 },
